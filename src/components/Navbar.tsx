...
export const Navbar = ({ onMenuClick }: NavbarProps) => {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-100 px-4 sm:px-8 flex items-center justify-between sticky top-0 z-10">
      <div className="flex items-center gap-3 flex-1 md:flex-none">
        <button
          onClick={onMenuClick}
          className="p-2 -ml-1 text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-colors lg:hidden"
          title="Open Menu"
        >
          <Menu className="w-5 h-5" />
        </button>

        <div className="hidden md:flex items-center gap-4 bg-gray-50 px-4 py-2 rounded-xl w-64 lg:w-96">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 cursor-pointer hover:bg-gray-50 p-1.5 rounded-xl transition-colors">
